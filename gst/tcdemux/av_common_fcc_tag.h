...
#ifndef AV_COMMON_FCC_TAG_H_
#define AV_COMMON_FCC_TAG_H_
...
// h.265(HEVC)
#define FOURCC_h265 (FOURCC('h','2','6','5'))
#define FOURCC_H265 (FOURCC('H','2','6','5'))
#define FOURCC_hvc1 (FOURCC('h','v','c','1'))
#define FOURCC_HVC1 (FOURCC('H','V','C','1'))
#define FOURCC_hevc (FOURCC('h','e','v','c'))
#define FOURCC_HEVC (FOURCC('H','E','V','C'))
#define FOURCC_HM10 (FOURCC('H','M','1','0'))
#define FOURCC_hm10 (FOURCC('h','m','1','0'))
...
// DIVX-6 Media format
#define	FOURCC_DXMF (FOURCC('D','X','M','F'))
#define	FOURCC_dxmf (FOURCC('d','x','m','f'))
...
#define FOURCC_MJPA (FOURCC('M','J','P','A'))
#define FOURCC_MJPB (FOURCC('M','J','P','B'))
...
#define AV_AUDIO_WMA_V1             (0x0160) //Windows Media Audio Standard encoded content
#define AV_AUDIO_WMA_V2             (0x0161) //Windows Media Audio Standard encoded content
...
#define AV_AUDIO_FOURCC_OPUS        (FOURCC('O','P','U','S'))
#define AV_AUDIO_ALAC               (0xa1ac)
...
#define FOURCC_mjp2 (FOURCC('m','j','p','2')) // jpeg2000
